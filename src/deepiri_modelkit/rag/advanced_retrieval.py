...
class MultiQueryRetriever:
    ...
    def retrieve(self, query: RAGQuery, num_queries: int = 3) -> List[RetrievalResult]:
        """
        ...
        expanded = self.query_expander.expand(
            query.query, max_expansions=num_queries - 1
        )
    ...
    def _fuse_results(
        self, all_results: Dict[str, List[RetrievalResult]], top_k: int
    ...
    def _reciprocal_rank_fusion(
        self, all_results: Dict[str, List[RetrievalResult]], top_k: int, k: int = 60
    ) -> List[RetrievalResult]:
        """
...
class AdvancedRetrievalPipeline:
    ...
    def __init__(
        ...
        self.multi_query_retriever: Optional[MultiQueryRetriever] = (
            MultiQueryRetriever(
